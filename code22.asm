section .data
    ...
    ;0
    num dq    18446744073709551615                            ; Binary number to convert
    ;  buffer db '00000000000000000000', 0xA
...
convert_loop:
    ...
    mov rdx, buffer+21          ; Compute the end of the string
    sub rdx, rsi                ; Calculate the actual length to print
